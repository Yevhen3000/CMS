...
* Student report
*/
SELECT s.fullname AS student_name, s.number AS student_number, c.name AS programme,
...
* Course report
*/
SELECT m.name AS module_name, c.name AS course_name, COUNT(e.student_id) AS enrolled_students, 
